...
```
go get github.com/aliyun/alibabacloud-yjopenapi-go-client 1.1.20230904
```
...
| ------------ | ------------- | ------------- | ------------- | ------------- |
 ...
 | *MultiplayApi* | **DemoCloseMultiPlay** | *DemoCloseMultiPlayForms*  | *MultiplayDemoCloseMultiPlayResult* | 联机demo关闭联机 |
 | *MultiplayApi* | **DemoInitMultiPlay** | *DemoInitMultiPlayForms*  | *MultiplayDemoInitMultiPlayResult* | 联机demo初始化联机 |
 | *MultiplayApi* | **DemoJoinMultiPlay** | *DemoJoinMultiPlayForms*  | *MultiplayDemoJoinMultiPlayResult* | 联机Demo加入联机接口 |
 | *MultiplayApi* | **DemoLeaveMultiPlay** | *DemoLeaveMultiPlayForms*  | *MultiplayDemoLeaveMultiPlayResult* | 联机demo离开联机 |
 | *MultiplayApi* | **DemoModifyMultiPlay** | *DemoModifyMultiPlayForms*  | *MultiplayDemoModifyMultiPlayResult* | 联机demo修改联机 |
 | *MultiplayApi* | **DemoQueryMultiPlay** | *DemoQueryMultiPlayForms*  | *MultiplayDemoQueryMultiPlayResult* | 联机demo查询联机接口 |
