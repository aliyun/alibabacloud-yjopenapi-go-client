...
func (s *ConsoleAdminApiService) CreateGame(
	...
	if varForms != nil && varForms.OsType != nil {
		varFormParams.Add("osType", parameterToString(*varForms.OsType, ""))
	}
...
func (s *ConsoleAdminApiService) GetBillFlowInfo(
	...
	if varForms != nil && varForms.TenantId != nil {
...
// GetGameInstanceContainerRatio
/*
 * 
 * @param varForms model.ConsoleAdminGetGameInstanceContainerRatioForms
 */
func (s *ConsoleAdminApiService) GetGameInstanceContainerRatio(
    varForms *model.ConsoleAdminGetGameInstanceContainerRatioForms,
) (model.ConsoleAdminGetGameInstanceContainerRatioResult, *http.Response, error) {
	var (
		varHttpMethod = strings.ToUpper("Post")
        varReturnValue model.ConsoleAdminGetGameInstanceContainerRatioResult
	)

	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/consoleAdmin/getGameInstanceContainerRatio"
	...
	varFormParams.Add("commodityInstanceId", parameterToString(varForms.CommodityInstanceId, ""))
	varFormParams.Add("games", parameterToString(varForms.Games, "multi"))
...
/*
 * 
 * @param varForms model.ConsoleAdminGetGameRecommendedInstanceForms
 */
func (s *ConsoleAdminApiService) GetGameRecommendedInstance(
    varForms *model.ConsoleAdminGetGameRecommendedInstanceForms,
) (model.ConsoleAdminGetGameRecommendedInstanceResult, *http.Response, error) {
	var (
		varHttpMethod = strings.ToUpper("Post")
        varReturnValue model.ConsoleAdminGetGameRecommendedInstanceResult
	)

	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/consoleAdmin/getGameRecommendedInstance"
	...
	varFormParams.Add("game", parameterToString(varForms.Game, ""))
	varFormParams.Add("commodityInstanceIds", parameterToString(varForms.CommodityInstanceIds, "multi"))
...
/*
 * 分游戏实时并发
 * @param varForms model.ConsoleAdminListGameCcuForms
 */
func (s *ConsoleAdminApiService) ListGameCcu(
    varForms *model.ConsoleAdminListGameCcuForms,
) (model.ConsoleAdminListGameCcuResult, *http.Response, error) {
	var (
		varHttpMethod = strings.ToUpper("Post")
        varReturnValue model.ConsoleAdminListGameCcuResult
	)

	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/consoleAdmin/listGameCcu"
	...
	if varForms != nil && varForms.MixGameIds != nil {
		varFormParams.Add("mixGameIds", parameterToString(*varForms.MixGameIds, ""))
	}
	if varForms != nil && varForms.ProjectIds != nil {
		varFormParams.Add("projectIds", parameterToString(*varForms.ProjectIds, ""))
	}
	if varForms != nil && varForms.QueryTimeStart != nil {
		varFormParams.Add("queryTimeStart", parameterToString(*varForms.QueryTimeStart, ""))
	}
	if varForms != nil && varForms.QueryTimeEnd != nil {
		varFormParams.Add("queryTimeEnd", parameterToString(*varForms.QueryTimeEnd, ""))
	}
	if varForms != nil && varForms.PageNumber != nil {
		varFormParams.Add("pageNumber", parameterToString(*varForms.PageNumber, ""))
	}
...
/*
 * 月度账单列表
 * @param varForms model.ConsoleAdminListMonthBillForms
 */
func (s *ConsoleAdminApiService) ListMonthBill(
    varForms *model.ConsoleAdminListMonthBillForms,
) (model.ConsoleAdminListMonthBillResult, *http.Response, error) {
	var (
		varHttpMethod = strings.ToUpper("Post")
        varReturnValue model.ConsoleAdminListMonthBillResult
	)

	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/consoleAdmin/listMonthBill"
...
// QueryAdaptResultByVersionId
/*
 * 查询适配结果
 * @param varForms model.ConsoleAdminQueryAdaptResultByVersionIdForms
 */
func (s *ConsoleAdminApiService) QueryAdaptResultByVersionId(
    varForms *model.ConsoleAdminQueryAdaptResultByVersionIdForms,
) (model.ConsoleAdminQueryAdaptResultByVersionIdResult, *http.Response, error) {
	var (
		varHttpMethod = strings.ToUpper("Post")
        varReturnValue model.ConsoleAdminQueryAdaptResultByVersionIdResult
	)

	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/consoleAdmin/queryAdaptResultByVersionId"
	...
	varFormParams.Add("mixVersionId", parameterToString(varForms.MixVersionId, ""))
...
/*
 * 实时并发数
 * @param varForms model.ConsoleAdminRtOverViewForms
 */
func (s *ConsoleAdminApiService) RtOverView(
    varForms *model.ConsoleAdminRtOverViewForms,
) (model.ConsoleAdminRtOverViewResult, *http.Response, error) {
	var (
		varHttpMethod = strings.ToUpper("Post")
        varReturnValue model.ConsoleAdminRtOverViewResult
	)

	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/consoleAdmin/rtOverView"
...
/*
 * 实时并发趋势图
 * @param varForms model.ConsoleAdminRtTrendForms
 */
func (s *ConsoleAdminApiService) RtTrend(
    varForms *model.ConsoleAdminRtTrendForms,
) (model.ConsoleAdminRtTrendResult, *http.Response, error) {
	var (
		varHttpMethod = strings.ToUpper("Post")
        varReturnValue model.ConsoleAdminRtTrendResult
	)

	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/consoleAdmin/rtTrend"
	...
	if varForms != nil && varForms.GroupType != nil {
		varFormParams.Add("groupType", parameterToString(*varForms.GroupType, ""))
	}
	if varForms != nil && varForms.IndicatorTypes != nil {
		varFormParams.Add("indicatorTypes", parameterToString(*varForms.IndicatorTypes, ""))
	}
	if varForms != nil && varForms.MixGameIds != nil {
		varFormParams.Add("mixGameIds", parameterToString(*varForms.MixGameIds, ""))
	}
...
/*
 * 订单退订
 * @param varForms model.ConsoleAdminSubmitRefundForms
 */
func (s *ConsoleAdminApiService) SubmitRefund(
    varForms *model.ConsoleAdminSubmitRefundForms,
) (model.ConsoleAdminSubmitRefundResult, *http.Response, error) {
	var (
		varHttpMethod = strings.ToUpper("Post")
        varReturnValue model.ConsoleAdminSubmitRefundResult
	)

	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/consoleAdmin/submitRefund"
	...
	varFormParams.Add("commodityCode", parameterToString(varForms.CommodityCode, ""))
	varFormParams.Add("instanceId", parameterToString(varForms.InstanceId, ""))
	varFormParams.Add("refundType", parameterToString(varForms.RefundType, ""))
	if varForms != nil && varForms.RefundReason != nil {
		varFormParams.Add("refundReason", parameterToString(*varForms.RefundReason, ""))
	}
	if varForms != nil && varForms.RefundReasonType != nil {
		varFormParams.Add("refundReasonType", parameterToString(*varForms.RefundReasonType, ""))
	}
	if varForms != nil && varForms.TargetExpireTime != nil {
		varFormParams.Add("targetExpireTime", parameterToString(*varForms.TargetExpireTime, ""))
	}
