...
/*
 * clientNotify
 * @param varForms model.ClientNotifyForms
 */
func (s *DispatchApiService) ClientNotify(
    varForms *model.ClientNotifyForms,
) (model.ClientNotifyResult, *http.Response, error) {
	var (
		varHttpMethod = strings.ToUpper("Post")
        varReturnValue model.ClientNotifyResult
	)

	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/clientNotify"
...
/*
 * replaceSlot
 * @param varForms model.ReplaceSlotForms
 */
func (s *DispatchApiService) ReplaceSlot(
    varForms *model.ReplaceSlotForms,
) (model.ReplaceSlotResult, *http.Response, error) {
	var (
		varHttpMethod = strings.ToUpper("Post")
        varReturnValue model.ReplaceSlotResult
	)

	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/replaceSlot"
	...
	varFormParams.Add("replaceSession", parameterToString(varForms.ReplaceSession, ""))
...
/*
 * tryToGetSlots
 * @param varForms model.TryToGetSlotsForms
 */
func (s *DispatchApiService) TryToGetSlots(
    varForms *model.TryToGetSlotsForms,
) (model.TryToGetSlotsResult, *http.Response, error) {
	var (
		varHttpMethod = strings.ToUpper("Post")
        varReturnValue model.TryToGetSlotsResult
	)

	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/tryToGetSlots"
	...
	varFormParams.Add("appKey", parameterToString(varForms.AppKey, ""))
	varFormParams.Add("parallelSchedule", parameterToString(varForms.ParallelSchedule, ""))
	varFormParams.Add("requests", parameterToString(varForms.Requests, "multi"))
