...
func (s *DispatchApiService) BatchStopGame(
	...
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/batchStopGame/v2"
...
func (s *DispatchApiService) CancelGameHang(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/cancelGameHang/v2"
...
func (s *DispatchApiService) GetGameConcurrency(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/getGameConcurrency/v2"
...
func (s *DispatchApiService) GetStock(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/getStock/v2"
...
func (s *DispatchApiService) GetStopGameToken(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/getStopGameToken/v2"
...
func (s *DispatchApiService) ListGameServerIp(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/listGameServerIp/v2"
...
func (s *DispatchApiService) QueryGameHang(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/queryGameHang/v2"
...
func (s *DispatchApiService) QuerySessionStatus(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/querySessionStatus/v2"
...
func (s *DispatchApiService) SetGameAlive(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/setGameAlive/v2"
...
func (s *DispatchApiService) SetGameHang(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/setGameHang/v2"
...
func (s *DispatchApiService) StopGame(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/stopGame/v2"
...
func (s *DispatchApiService) TryToGetSlot(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/tryToGetSlot/v2"
