...
func (s *LiveApiService) QueryStatus(
	...
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/live/queryStatus/v2"
...
func (s *LiveApiService) StartGameLive(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/live/startGameLive/v2"
...
func (s *LiveApiService) StopGameLive(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/live/stopGameLive/v2"
