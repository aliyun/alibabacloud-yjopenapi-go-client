...
func (s *AiApiService) UploadModels(
	...
	varFormParams.Add("modelType", parameterToString(varForms.ModelType, ""))
	varFormParams.Add("modelName", parameterToString(varForms.ModelName, ""))
	varFormParams.Add("modelFilePath", parameterToString(varForms.ModelFilePath, ""))
	varFormParams.Add("modelFiles", parameterToString(varForms.ModelFiles, "multi"))
	if varForms != nil && varForms.Desc != nil {
		varFormParams.Add("desc", parameterToString(*varForms.Desc, ""))
	}
	varFormParams.Add("modelFileType", parameterToString(varForms.ModelFileType, ""))
