...
func (s *UsercontrollerApiService) DeleteGameArchive(
	...
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/usercontroller/deleteGameArchive/v2"
...
func (s *UsercontrollerApiService) GetGameTrialSurplusDuration(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/usercontroller/getGameTrialSurplusDuration/v2"
...
func (s *UsercontrollerApiService) GetUserGameArchive(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/usercontroller/getUserGameArchive/v2"
...
func (s *UsercontrollerApiService) ListLatestGameArchive(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/usercontroller/listLatestGameArchive/v2"
...
func (s *UsercontrollerApiService) RestoreGameArchive(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/usercontroller/restoreGameArchive/v2"
...
func (s *UsercontrollerApiService) UpdateGameArchiveTagStatus(
	...
	// create path and map variables
	varPath := s.client.cfg.Scheme + "://" + s.client.cfg.Host + "/usercontroller/updateGameArchiveTagStatus/v2"
